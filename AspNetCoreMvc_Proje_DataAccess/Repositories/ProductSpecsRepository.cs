...
{
    public class ProductSpecsRepository : GenericRepository<ProductSpecs>, IProductSpecsDal
    {
        public ProductSpecsRepository(ECommerceDbContext context) : base(context)
        {
        }
    }
}
